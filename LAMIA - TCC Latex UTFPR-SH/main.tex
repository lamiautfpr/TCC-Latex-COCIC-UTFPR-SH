...
\usepackage[titles]{tocloft} % formata sumário, lista de figura e lista de tabela

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%C O N F I G U R A Ç Õ E S A D I C I O N A I S
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setlist[itemize]{leftmargin=1.25cm} % indetação da lista de elementos (enumarate e itemize)

% formatação do the table of contents (TOC) -----------
\renewcommand{\cftsecfont}{\bfseries} %comente essa linha se o texto não for em negrito
\setlength{\cftsecindent}{0pt}% Remove a indentação para as seções no sumário
\setlength{\cftsubsecindent}{0pt}% Remove a indentação para as subseções no sumário

\renewcommand{\cftfigpresnum}{\figurename\enspace} % adiciona o label Figura antes da numeração
\renewcommand{\cftfigaftersnum}{ - } % adiciona um - depois da numeração
\renewcommand{\cftfignumwidth}{2cm}

\renewcommand{\cfttabpresnum}{\tablename\enspace} %adiciona o label Figura antes da numeração
\renewcommand{\cfttabaftersnum}{ - } % adiciona um - depois da numeração
...
\printbibliography
\phantomsection % comando necessário para adição de entradas nas referências
\addcontentsline{toc}{chapter}{\texorpdfstring REEFERÊNCIAS} % adiciona as referências no sumário
\newpage
...
% A N E X O (opcional)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \inputannex{elementos-postextuais/anexo1.tex}{A}{Exemplos de Objetivo Geral e Específicos}
