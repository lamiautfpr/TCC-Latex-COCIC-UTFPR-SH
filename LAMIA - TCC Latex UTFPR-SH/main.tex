...
\usepackage[backend=biber, style=abnt, uniquename=mininit, giveninits, extrayear, repeattitles, backref, noslsn]{biblatex} %pacote com todas as funções de bibliograficas modernas do latex, pesquise as variações do comando \cite e \textcite disponíveis com o biblatex 
