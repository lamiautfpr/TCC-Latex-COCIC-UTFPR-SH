...
% LaTeX:  abnTeX2   
% Projeto hospedado em: <https://github.com/lamia-utfpr/TCC-Latex-COCIC-UTFPR-SH>
...
\usepackage[backend=biber, style=abnt, uniquename=mininit, giveninits, extrayear, repeattitles, backref]{biblatex} %pacote com todas as funções de bibliograficas modernas do latex, pesquise as variações do comando \cite disponíveis com o biblatex 
